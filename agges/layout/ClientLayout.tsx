    ...
    <div className="flex flex-col min-h-screen w-full">
      ...
      <header className="flex items-center justify-between px-8 py-4 bg-[var(--color-dark-gray)] shadow-[0_2px_4px_rgba(0,0,0,0.2)] h-[70px]">
        ...
        <nav className="flex gap-8 max-md:hidden">
          <Link 
            ...
            className={`text-white no-underline font-medium transition-colors duration-300 hover:text-[var(--color-primary)] ${
              isActive('/client/dashboard') ? 'text-[var(--color-primary)]' : ''
            }`}
          >
            Dashboard
          </Link>
          <Link 
            href="/client/cotizacion"
            className={`text-white no-underline font-medium transition-colors duration-300 hover:text-[var(--color-primary)] ${
              isActive('/client/cotizacion') ? 'text-[var(--color-primary)]' : ''
            }`}
          >
            Cotizaciones
          </Link>
          <Link 
            href="/client/archivos"
            className={`text-white no-underline font-medium transition-colors duration-300 hover:text-[var(--color-primary)] ${
              isActive('/client/archivos') ? 'text-[var(--color-primary)]' : ''
            }`}
          >
            Archivos
          </Link>
        ...
        <div className="flex items-center gap-4">
          <span className="text-white font-medium max-md:hidden">Cliente</span>
          <button
            onClick={logout}
