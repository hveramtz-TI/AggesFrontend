...
const Hero = () => {
  return (
    <section className="w-full md:h-screen h-[90vh] flex items-center justify-center relative overflow-hidden p-8">
      {/* Gradiente de fondo */}
      <div
      ...
      {/* Contenido */}
      <div className="max-w-[800px] w-full flex flex-col items-center justify-center relative z-2">
        <Image
          src="/logo.webp"
          alt="Logo Agges"
          width={1000}
          height={1000}
          className="md:mb-20 mb-30"
        />
      </div>
    </section>
  )
